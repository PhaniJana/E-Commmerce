      ...
      <div className='text-2xl text-center pt-8 border-t'>
        ...
        <div className="my-10 flex flex-col md:flex-row gap-16">
          ...
          <div className="flex flex-col justify-center gap-6 md-w-2/4 text-gray-600">
            ...
            <p>Our mission at Forever is to empower customers with choice, convenience, and confidence. We're dedicated to 
              providing a seamless shopping experience that exceeds expectations, from browsing and ordering to delivery and beyond.</p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row text-sm mb-20 ">
          <div className='border border-gray-200 px-10 md:p-16 py-8 sm:py-20 flex flex-col gap-5 '>
